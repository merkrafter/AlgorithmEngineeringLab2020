...
\begin{itemize}
  ...
  %\item only an idea, so better rethink: cache the hights of the highest towers of both players (avoids costly recalculation in every explored node); recalculation only necessary if new higher tower was built or a tower with the max height of a player was taken
